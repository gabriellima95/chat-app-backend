...
func NewMessageController(messageRepository storage.MessageRepository, chatRepository storage.ChatRepository, socketNotifier websocket.Notifier) MessageController {
